class DiariesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @diary.save
        format.html { redirect_to diary_url(@diary), notice: "新しい日記が作成されました。" }
  ...
  def update
    respond_to do |format|
      if @diary.update(diary_params)
        format.html { redirect_to diary_url(@diary), notice: "日記は正常に更新されました。" }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to diaries_url, notice: "日記は削除されました。" }
